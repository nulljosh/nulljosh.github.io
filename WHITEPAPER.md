...
[heyitsmejosh.com](https://heyitsmejosh.com) is the personal site and hub for every
shipped project. Static HTML, CSS, and JavaScript with no build step, hosted on
GitHub Pages.
